...
class Fox:
    ...
    def advance(self, state, pad):
        while self.action_list:
            ...
            if state.players[2].action_state == AI.state.ActionState.Wait:
                self.dashdance(pad)
    ...
    def shinespam(self, pad):
        ...
        self.action_list.append((1, pad.release_button, [AI.pad.Button.B]))
        ...
        self.action_list.append((10, pad.tilt_stick, [AI.pad.Stick.MAIN, 0.5, 0.5]))
